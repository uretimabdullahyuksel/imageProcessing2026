...
plt.figure(), plt.imshow(white_noise, cmap="gray"), plt.axis("off"), plt.title("white_noise"), plt.show()
noise_img = white_noise+img
plt.figure(), plt.imshow(noise_img, cmap="gray"), plt.axis("off"), plt.title("white noise_img"), plt.show()
...
plt.figure(), plt.imshow(black_noise, cmap="gray"), plt.axis("off"), plt.title("black_noise"), plt.show()
black_noise_img = black_noise+img
black_noise_img[black_noise_img <= -245]=0
plt.figure(), plt.imshow(black_noise_img, cmap="gray"), plt.axis("off"), plt.title("black noise_img"), plt.show()
