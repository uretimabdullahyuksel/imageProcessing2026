...
MODEL_PATH = r"D:\git\projects\teknim_kontak_yay\runs_200\roboflow_yolo_train_200\weights\best.pt"
IMG_PATH   = r"D:\git\projects\teknim_kontak_yay\images\1.jpg"

OUTPUT_DIR = "outputs_yaysiz"
...
def main():
    ...
    print("Tüm görüntüde sadece yaysız kontak aranıyor...")
    ...
    cv2.imshow("Sadece Yaysiz Kontaklar", show)
    cv2.waitKey(0)
